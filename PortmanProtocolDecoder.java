...
public class PortmanProtocolDecoder extends BaseProtocolDecoder {
    ...
    private Object decodeStandard(Channel channel, SocketAddress remoteAddress, String sentence) {
        ...
        Position position = extractedDuplCode(channel, remoteAddress, parser);
	...
	private Position extractedDuplCode(Channel channel, SocketAddress remoteAddress, Parser parser) {
		if (!parser.matches()) {
            return null;
        }
