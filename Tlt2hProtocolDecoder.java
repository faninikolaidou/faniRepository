...
public class Tlt2hProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        return extractedLong(deviceSession, door, adc, power, battery, temperature, status, messages, positions);
    }

	private Object extractedLong(DeviceSession deviceSession, Boolean door, Double adc, Double power, Double battery,
			Double temperature, String status, String[] messages, List<Position> positions) {
		Parser parser;
